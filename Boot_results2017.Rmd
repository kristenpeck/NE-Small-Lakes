...
```{r Figure-FL freq, echo=F, results='asis', warning = FALSE, fig.height=6, fig.width=6, fig.cap= "Figure FL hist: Frequency of lengths of species caught during the survey on Boot Lake in September 2002 and September 2017: EB = eastern brook trout, LKC = lake chub, and RB = rainbow trout. "}
plot(Figure.FL.yr)
