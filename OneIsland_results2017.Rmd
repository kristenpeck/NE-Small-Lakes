...
```{r Figure RB ages, echo=F, results='asis', warning = FALSE, fig.height=4, fig.width=6, dpi=300, fig.cap= "Figure : Frequency of ages of Brook Trout (EB) and Rainbow Trout (RB) in 2003 and 2017"}
